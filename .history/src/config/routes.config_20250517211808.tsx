...
import CreateUser from "../pages/admin/users/admin.adduser";
import UserEdit from "../pages/admin/users/admin.user.edit";
import NotFoundPage from "../pages/not found/not.found";
import UserHomePage from "../Layouts/user.layout/user.home.page";
import ListPosts from "../pages/user role/list.post";
import CreateBlog from "../pages/user role/create.blog";
import ProfilePage from "../pages/user role/profile.page";
...
export const router = createBrowserRouter([
  {
    path: "/",
    element: (
      <Suspense fallback={<Spin fullscreen tip="Loading...." size="default" indicator={<LoadingOutlined/>} />}>
        <HomePage />
      </Suspense>
    ),
  },
