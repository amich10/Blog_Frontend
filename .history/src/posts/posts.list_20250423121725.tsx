    ...
    const tableColumns = [
       ...
       /*  {
        ...
        }, */
        {
            ...
            category ? (
                <span className="bg-yellow-100! px-2 py-1 rounded-md text-xs text-yellow-900!">{category.title}</span>
            ) : (
            ...
            render: (tags: string[]) => (
                <div className="flex flex-wrap gap-2">
                    {tags.map((tag, index) => (
                        <span
                            key={index}
                            className="px-2 py-1 rounded bg-blue-100 text-black text-xs"
                        >
                            {tag}
                        </span>
                    ))}
