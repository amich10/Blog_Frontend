...
const CreatePost = () => {
  ...
  const props: UploadProps = {
    ...
    onRemove: (file) => {
      ...
      // If using react-hook-form or similar, handle how you want to store multiple files
      setValue("image", newFileList.length > 0 ? newFileList : null);
    },
    beforeUpload: (file) => {
      // Prevent default upload behavior and manage files manually
      ...
      setValue("image", uniqueList); // Store array of files
      return false;
    },
    fileList,
  };
