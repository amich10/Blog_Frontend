...
const CreatePost = () => {
  ...
  const CreatePostSchema = Yup.object({
    ...
    categoryId: Yup.string().min(20).max(6000).required("Category is required"),
    content: Yup.string().minmax(5000),
      ...
      <form onSubmit={handleSubmit(submitHandler)}>
        ...
        <div className="flex flex-col gap-1 sm:flex-row sm:gap-4 sm:mb-2 sm:mr-4">
          <InputLabel htmlFor="tags" classses="w-full sm:w-1/3">
            ...
            <TagsInputController name="tags" control={control} errorMsg={errors?.tags?.message}
            placeholder="add tags to your posts" classes={'w-full'}
