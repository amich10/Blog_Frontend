    ...
    const tableColumns = [
       ...
       /*  {
        ...
        }, */
        {
            ...
            category ? (
                <a className="bg-yellow-200! px-2 py-1 rounded-md text-xs text-black!">{category.title}</a>
            ) : (
            ...
            render: (tags: string[]) => (
                <div className="flex flex-wrap gap-2">
                    {tags.map((tag, index) => (
                        <span
                            key={index}
                            className="px-2 py-1 rounded bg-blue-200 text-black text-xs"
                        >
                            {tag}
                        </span>
                    ))}
