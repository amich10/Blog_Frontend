...
const PostList = () => {
    const tableColumns = [
        ...
        // },
        {
            ...
            optimizedUrl
            : 
            "https://res.cloudinary.com/dkunajgg7/image/upload/f_auto,q_auto/v1/blog-platform/Posts/tliotfm11ppwcqgzabyb?_a=BAMCkGTG0"
            url
            : 
            "https://res.cloudinary.com/dkunajgg7/image/upload/v1744725873/blog-platform/Posts/tliotfm11ppwcqgzabyb.jpg"
            _id
            : 
            "67fe6774059f5d108ecfec9d"
            [[Prototype]]
            : 
            Object
            1
            ...
            optimizedUrl
            : 
            "https://res.cloudinary.com/dkunajgg7/image/upload/f_auto,q_auto/v1/blog-platform/Posts/ixa8qc5mndwjifeacocj?_a=BAMCkGTG0"
            url
            : 
            "https://res.cloudinary.com/dkunajgg7/image/upload/v1744725874/blog-platform/Posts/ixa8qc5mndwjifeacocj.jpg"
            _id
            : 
            "67fe6774059f5d108ecfec9e"
            [[Prototype]]
            : 
            Object
            length
        ...
        },
        {
            ...
            render: (images: IPostType["images"]) =>
                images && images.optimizedUrl ? (
                    <img src={images.optimizedUrl} alt="image" className="w-20 h-15" />
                ) : (
