    ...
    const tableColumns = [
       ...
       /*  {
        ...
        }, */
        {
            ...
            category ? (
                <span className="font-medium text-gray-800 italic">{category.title}</span>
            ) : (
                <span className="text-gray-600 italic italic">No category</span>
            ),
        },
        {
            title: "Images",
        ...
        },
        {
            ...
            render: (id: IPostType["_id"]) => (
                <div className="flex gap-5">
                    ...
                    <Popconfirm
                        title="Are you sure you want to delete this post?.Once, deleted it cannot be reverted back."
                        okText="Yes"
                        cancelText="Cancel"
                        ...
                        onConfirm={() => {async() =>{
                            try {
                                ...
                                notifcation("Pose deleted successfully",NotificationType.SUCCESS)
                            } catch (exception) {
                                notifcation("Sorry, post cannot be delete now.Please,try again later",NotificationType.ERROR)
