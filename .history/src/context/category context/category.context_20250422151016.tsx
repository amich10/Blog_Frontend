...
interface ICategoryContext {
 ...
 categoryData: Array<IResult> | undefined;
}


export const CategoryContext = createContext<ICategoryContext>({
    category: async (): Promise<void> => {}, 
    categoryData: [] as Array<IResult>
})
...
export const CategoryContextProvider = ({children}:IChildrenProps) =>{
    ...
    return (
        <>
       <CategoryContext.Provider value={{ category: allCategories,categoryData:categoryData }}>
        {children}
...
export const useCategory = () =>{
    const {category,categoryData} = useContext(CategoryContext)
    return {
        category,
        categoryData
    }
