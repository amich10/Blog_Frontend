...
interface ICategoryContext {
 ...
 categoryData: IResult[] | undefined;
}


export const CategoryContext = createContext<ICategoryContext>({
    category: async (): Promise<void> => {}, 
    categoryData: {} as IResult
})
...
export const CategoryContextProvider = ({children}:IChildrenProps) =>{
    ...
    return (
        <>
       <CategoryContext.Provider value={{ category: allCategories,categoryData:categoryData as IResult }}>
    <CategoryContext.Provider value={{ category: allCategories, categoryData }}>
