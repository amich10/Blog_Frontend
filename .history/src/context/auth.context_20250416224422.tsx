...
export const AuthContext = createContext({
    ...
    setUserDetails: React.Dispatch<React.SetStateAction<IUserDetails | undefined>>
})
...
export const useAuth = () =>{
   const {login,forgetPassword,userDetails, setLoggedInUser} = useContext(AuthContext)
   return {
    login,
    forgetPassword,
    userDetails,
