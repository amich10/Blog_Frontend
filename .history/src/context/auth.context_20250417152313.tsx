...
export interface IAuthContext {
  ...
  export const AuthContext = createContext<IAuthContext>({
    login: async (_credentials: ICredentials): Promise<void> => {}, // Default async function for login
    forgetPassword: async (_data: { email: string }): Promise<void> => {}, // Default async function for forgetPassword
    userDetails: {} as IUserDetails, // Default empty userDetails
    setUserDetails: () => {}, // Default empty function for setUserDetails
  });
  ...
  return (
    <AuthContext.Provider
      value={{
        ...
        userDetails: userDetails as IUserDetails, // this should not be {}
        setUserDetails: setUserDetails, // Correctly set setUserDetails
      }}
    >
      {children}
    </AuthContext.Provider>
