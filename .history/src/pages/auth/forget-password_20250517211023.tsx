...
import { InputLabel, TextInputController } from "../../components";
...
export const ForgetPasswordPage = () => {
  ...
  const onSubmit =async (data: IForgetPasswordDTO) => { //this is done because this ForgetPassword component does not lie with router when navigate is passsed throuh auth context
