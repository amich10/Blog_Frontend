...
export const ForgetPasswordPage = () => {
  ...
  const onSubmit =as (data: IForgetPasswordDTO) => { //this is done because this ForgetPassword component does not lie with router when navigate is passsed throuh auth context
    forgetPassword(data);
    navigate('/')  
  };
