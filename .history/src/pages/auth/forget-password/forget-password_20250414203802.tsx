...
export const ForgetPasswordPage = () => {
  ...
  const onSubmit = asyta: IForgetPasswordDTO) => { //this is done because this ForgetPassword component does not lie with router when navigate is passsed throuh auth context
    forgetPassword(data);
    navigate('/')  
  };
