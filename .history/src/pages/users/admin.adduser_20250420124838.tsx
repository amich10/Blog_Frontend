        ...
        <Layout.Content className="bg-white p-8 rounded-md shadow-md">
            ...
            <div>
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4 sm:mb-2">
                    ...
                    <TextInputController  classes={'w -full sm:w-2/3'} name="email" control={control} errorMsg={errors?.username?.message} placeholder="example@example.com" type="text"></TextInputController>
                </div>
