        ...
        <Layout.Content className="bg-white p-8 rounded-md shadow-md">
            ...
            <div>
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4">
                    ...
                    <PasswordInputController classes={'w-full sm:'}  name="password" control={control} errorMsg={errors?.fullName?.message} placeholder="Enter full name here..." type="text"></TextInputController>
                </div>
            </div>
        </Layout.Content>
        </>
