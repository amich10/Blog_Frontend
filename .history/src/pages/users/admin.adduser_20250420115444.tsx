        ...
        <Layout.Content className="bg-white p-8 rounded-md shadow-md">
            ...
            <div>
                <div className="flex">
                    ...
                    <TextInputController classes={'w-4/4'} name="fullName" control={control} errorMsg={errors?.fullName?.message} placeholder="Enter full name here..." type="text"></TextInputController>
                </div>
            </div>
        </Layout.Content>
        </>
