        ...
        <Layout.Content className="bg-white p-8 rounded-md shadow-md">
            ...
            <div>
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4 sm:mb-2">
                    ...
                    <TextInputController  classes={'w -full sm:w-2/3'} name="fullName" control={control} errorMsg={errors?.fullName?.message} placeholder="full" type="text"></TextInputController>
                </div>
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4 sm:mb-2">
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4 sm:mb-2">
                    ...
                    <TextInputController  classes={'w -full sm:w-2/3'} name="email" control={control} errorMsg={errors?.username?.message} placeholder="Enter your username here..." type="text"></TextInputController>
                </div>
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4 sm:mb-2">
                    ...
                    <PasswordInputController classes={'w-full sm:w-2/3'}  name="confirmPassword" control={control} errorMsg={errors?.confirmPassword?.message} type="text"/>
                </div>
            </div>
        </Layout.Content>
        </>
