            ...
            setPagination((prev) => (
                {
                    ...
                    total: response.result.options.pagination.totalDocs || prev.total // Ensure total is set for pagination
                }
            ))
            ...
            ),
        {
            ...
            render: (id: string) => (
                <div className="flex gap-5">
                    {/* Future action buttons can use the id */}
                    {/* Example: <button onClick={() => handleEdit(id)}>Edit</button> */}
                </div>
            ),
        },
        },
