    ...
    return (
        ...
        <Layout.Content className="bg-white p-8 rounded-md shadow-md">
            ...
            <div>
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4 sm:mb-2">
                    <InputLabel htmlFor="gender" classses={'w-full sm:w-1/3'}>Select a gender</InputLabel>
                    <SelectInputController options={[
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4 sm:mb-2 sm:mb-7">
                    <InputLabel htmlFor="socialLinks" classses={' w-full sm:w-1/3'}>Socail Links</InputLabel>
                    <TextInputController classes={'w-full sm:w-2/3 sm:ml-1'}  name="socialLinks" control={control} errorMsg={errors?.socialLinks?.message} placeholder="facebook link here..."/>
                </div>
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4 sm:mb-2 w-full">
                    <InputLabel htmlFor="bio" classses={' w-full sm:w-1/3'}>Bio</InputLabel>
                    <TextAreaController classes={' max-w-full sm:w-2/3'}  name="bio" control={control} errorMsg={errors?.bio?.message} placeholder="Write what represents you."/>
                </div>
            </div>
        </Layout.Content>
        </>
