...
const CreateUser = () =>{
    ...
    return (
        ...
        <Layout.Content className="bg-white p-8 rounded-md shadow-md">
            ...
            <div>
                <div className="flex">
                    <InputLabel htmlFor="fullName w-1/4">Full Name</InputLabel>
                    <TextInputController classes={'w'} name="fullName" control={control} errorMsg={errors?.fullName?.message} placeholder="Enter full name here..." type="text"></TextInputController>
                </div>
            </div>
        </Layout.Content>
        </>
