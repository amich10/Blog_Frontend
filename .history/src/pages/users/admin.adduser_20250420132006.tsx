    ...
    return (
        ...
        <Layout.Content className="bg-white p-8 rounded-md shadow-md">
            ...
            <div>
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4 sm:mb-2 max-w-full">
                    <InputLabel htmlFor="bio" classses={' w-full sm:w-1/3'}>Bio</InputLabel>
                    <TextAreaController classes={'w-full sm:w-2/3 max-w-full flex-1'}  name="bio" control={control} errorMsg={errors?.bio?.message} placeholder="Write what represents you."/>
                </div>
            </div>
        </Layout.Content>
        </>
