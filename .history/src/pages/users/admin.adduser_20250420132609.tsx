    ...
    return (
        ...
        <Layout.Content className="bg-white p-8 rounded-md shadow-md">
            ...
            <div>
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4 sm:mb-2 sm:ml-1">
                    <InputLabel htmlFor="socialLinks" classses={' w-full sm:w-1/3'}>Socail Links</InputLabel>
                    <TextInputController classes={'w-full sm:w-2/3'}  name="socialLinks" control={control} errorMsg={errors?.socialLinks?.message} placeholder="facebook link here..."/>
                </div>
