...
import { InputLabel, PasswordInputController, RegisterDTO, TextAreaController, TextInputController } from "../../components/input.component";
        ...
        <Layout.Content className="bg-white p-8 rounded-md shadow-md">
            ...
            <div>
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4 sm:mb-2">
                    ...
                    <PasswordInputController classes={'w-full sm:w-2/3'}  name="phone" control={control} errorMsg={errors?.confirmPassword?.message} placeholder="10 digit mob-number"/>
                </div>
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4 sm:mb-2">
                    <InputLabel htmlFor="address" classses={' w-full sm:w-1/3'}>Phone (mob)</InputLabel>
                    <TextAreaController classes={'w-full sm:w-2/3'}  name="address" control={control} errorMsg={errors?.confirmPassword?.message} placeholder="10 digit mob-number"/>
                </div>
