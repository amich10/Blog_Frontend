...
import { FormSingleImageUploader } from "../../components/image.uploader.component";
import { IUserType } from "./admin.user.list";
          ...
          <div>
            ...
            <div className="flex flex-col gap-1 sm:flex-row sm:gap-4 sm:mb-2 sm:mr-4">
             ...
             <div className="w-full">
                <FormSingleImageUploader name="image" thumbnail={imageData} setValue={(name: "status" | "fullName" | "username" | "email" | "password" | "address" | "role" | "phone" | "gender" | "bio" | "image" | "socialLinks", file: any) => setValue(name, file)}/>
             </div>
            </div>
