        ...
        const tableColumns = [
            ...
            },
            {
                ...
                render: (id: string) => (
                    ...
                    <NavLink to={'/admin/users/edit'} className="text-green-500!">
                        <EditOutlined/>
                    </NavLink>
                    <Popconfirm
                        title="Are you sure"
                        ...
                        okText="Yes"
                        cancelText="Cancel"
                        okButtonProps={{ className: "bg-red-600! rounded-full!" }}
                        cancelButtonProps={{ className: "bg-green-600! text-white! rounded-full!" }}
                        onConfirm={async () => {
                            try {
                                await userSvc.getRequest('/user' + id)
                    ...
                    >
                        <span className="text-red-500 rounded-full bg-red-50 p-2 hover:bg-red-100 transition">
                            <DeleteOutlined />
                        </span>
                    </Popconfirm>    </div>
                ),
