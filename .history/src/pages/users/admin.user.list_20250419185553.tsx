    ...
    const UserList = () =>{
        ...
        // Remove this effect, as the above effect now handles search and pagination together
        },[search])
        ...
        const handleTableChange = (pagination:TablePaginationConfig) =>{
            ...
            },
            {
                ...
                render: (id: string) => (
                    <div className="flex gap-5">
                        {/* Example actions, replace with your logic */}
                        <NavLink to={`/admin/user/edit/${id}`} className="text-blue-600 hover:text-blue-800">
                            Edit
                        </NavLink>
                        <button
                            ...
                            onClick={() => {
                                ...
                                notifcation("Delete action clicked", NotificationType.INFO);
                            }}
                        >
                            Delete
                        </button>
