...
const CreateUser = () => {
    ...
    const createUserSchema = Yup.object({
      ...
      bio: Yup.string().max(500, "Bio cannot exceed 200 characters"),
      image: Yup.object({
        url: Yup.string().url("Invalid image URL").required("Image URL is required"),
        optimizedUrl: Yup.string().url("Invalid optimized image URL").required("Optimized image URL is required"),
      }).nullable(),
