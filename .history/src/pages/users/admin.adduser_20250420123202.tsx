        ...
        <Layout.Content className="bg-white p-8 rounded-md shadow-md">
            ...
            <div>
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-4 mb-4">
                    ...
                    <TextInputController  classes={'sm:2/3'} name="fullName" control={control} errorMsg={errors?.fullName?.message} placeholder="Enter full name here..." type="text"></TextInputController>
                </div>
            </div>
        </Layout.Content>
        </>
