...
const CategoryList = () => {
  ...
  const getAllCategory = async ({
    ...
    try {
      ...
      notifcation(
        "Sorry, the list of categories cannot be retireved now. Please,try again later",
      ...
      render: (image: IResult["image"]) =>
        image && image.optimizedUrl ? (
          <img
            ...
            alt="category"
            className="w-2 h-10 object-cover"
          />
        ) : (
          ...
          <Popconfirm
            ...
            onConfirm={async () => {
              try {
                ...
                notifcation(
                  "Sorry,error occured in deleting category.Please,try again later",
                  NotificationType.ERROR
                );
              }
            }}
