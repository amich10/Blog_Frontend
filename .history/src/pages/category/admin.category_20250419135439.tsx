...
const CategoryList = () =>{
    ...
    return (
      ...
      <div className="flex justify-between mt-3">
        <Input.Search placeholder="Search category" onChange={(e) => {
            setSearch(e.target.value)
        }} className="w-100!" />
        <NavLink to="/admin/category/create" className=" border-2 border-black text-white! rounded-md p-1.5 hover:bg-green-800!">
