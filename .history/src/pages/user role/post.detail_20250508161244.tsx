...
import { useCategory } from "../../context/post.contex";
...
const PostDetail = () => {
  ...
  const { category }: { category: Array<{ _id: string; image?: { optimizedUrl?: string } }> } = useCategory();
        ...
        <div className="w-3/4 h-full border-r border-gray-200 px-8 py-2">
          <div className="p-6 rounded-lg">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              {category.find((cat: { _id: string; image?: { optimizedUrl?: string } }) => cat._id === post.authorId)?.image?.optimizedUrl}
              </span>
              <Button
                type="text"
                icon={
