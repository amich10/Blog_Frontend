      ...
      <div className="min-h-screen flex">
        ...
        <div className="w-1/4 h-full px-3 py-4 sticky top-0">
            ...
            <div className='mt-4 border border-gray-100 p-2'>
                    ...
                    comments.map((comment: any, idx: number) => (
                      <div key={idx} className="bg-white border border-gray-200 rounded-md p-2">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          />
                          <span className="font-extralight text-xs">{comment.userId.username || 'Anonymous'}</span>
                          <span className="text-xs text-gray-400 ml-auto">{comment.createdAt ? new Date(comment.createdAt).toLocaleString() : ''}</span>
                        </div>
                ...
                <div className="mt-4">
                <form onSubmit={handleSubmit((data) => createComment({ ...data, postId: post._id }))}>
                  ...
                  name='content'
                  />
                  <Button  htmlType= "submit" type="primary" className="bg-[#4f6f52]! flex! justify-center! items-center!">Submit</Button>
                  </form>
                </div>
