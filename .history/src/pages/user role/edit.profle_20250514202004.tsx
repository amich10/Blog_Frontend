          ...
          <div className="px-6 py-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                 ...
                 <div className="md:col-span-2">
                 <InputLabel htmlFor="SocailMedia" classses={"block text-sm font-medium text-gray-700 mb-1"}>Bio</InputLabel>
                  <TextInputController
                    name="socialMedia"
                    control={control}
                   errorMsg={errors?.address?.message}
                  />
                  {errors.bio && (
                    <p className="text-red-500 text-sm">{errors?.s?.message}</p>
                  )}
                </div>
              </div>
