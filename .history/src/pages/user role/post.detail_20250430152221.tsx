    ...
    <Layout.Content className="bg-white">
      <div className="min-h-screen flex">
        ...
        <div className="w-1/4 h-full px-8 py-4 sticky top-0">
            <div className='border-1 border-gray-100 p-2 rounded-md shadow shadow-2xl'>
            <h2 className="font-semibold text-white mb-2 rounded-2xl bg-[#4f6f52] py-1 px-3 w-15 text-center">Tags</h2>
