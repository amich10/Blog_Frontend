...
const EditProfile = () => {
  ...
  return (
    <Layout.Content className="bg-white rounded-lg shadow-md overflow-hidden">
          {/* Cover Image Section */}
          <div className="relative h-48 bg-gray-200">
            <img
              id="coverPreview"
              src={coverImageData || "https://via.placeholder.com/1200x300"}
              alt="Cover"
              ...
              <div className="relative">
                ...
                <div className="absolute bottom-2 right-2">
                  <Upload {...imageUploadProps} showUploadList={false}>
                    <button className="bg-gray-700 text-white p-2 rounded-full hover:bg-gray-800 transition">
