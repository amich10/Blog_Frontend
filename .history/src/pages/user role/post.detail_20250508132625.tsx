...
const PostDetail = () => {
  ...
  const authUserId = userDetails._id
  const userHasLiked = authUserId && post?.likes?.includes(authUserId);

  const likePost = async () => {
    if (userHasLiked) {
      notifcation("You've already liked this post.", NotificationType.INFO);
      return;
    }
    try {
