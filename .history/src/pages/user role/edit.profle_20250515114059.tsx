...
const EditProfile = () => {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      notifcation("Profile edited successfully",NotificationType.)
  ...
  useEffect(() => {
    if (userDetails) {
      ...
      setValue("image", userDetails.image.optimizedUrl);
      setValue("coverImage", userDetails.coverImage.optimizedUrl);
