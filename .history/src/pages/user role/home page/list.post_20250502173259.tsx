...
useEffect(() =>{
  ...
  const [randomIndea,setRandomIdea] = useState<string>("")
  useEffect(() =>{
    const randomIndex = Math.floor (Math.random() * ideas.length)
    setRandomIdea(ideas[ra])
  },[ideas])
  ...
  return (
    <Content className="shadow-xl rounded-md bg-white relative">
      <div className="flex h-full">
        ...
        <Button
              type="primary"
              className="!bg-[#4f6f52] hover:!bg-[#3d5842] w-full h-20! flex justify-center items-center mb-3! border-b! border-gray-100!"
            >
              <NavLink to={'/blogs/create'} className="text-white font-semibold text-lg"> <FormOutlined/> Write your own Blog</NavLink>
              <span></span>
        </Button>
