    ...
    <Content className="shadow-xl rounded-md bg-white relative">
      <div className="flex h-full">
        ...
        <div className="w-1/4 h-full p-6 space-y-8 sticky top-0">
          ...
          {/* Recommended Topics */}
            <div className="h-20 border border-gray-100 rounded-md px-6 flex justify-center items-center bg-[#f9f9f9] hover:bg-[#e8f5e9] transition duration-300 cursor-pointer">
            <span className="text-[#4f6f52] font-semibold text-lg">Create a Blog</span>
            </div>
