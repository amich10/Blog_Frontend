          ...
          >
            ...
            <div>
              ...
              <TextInputController
                ...
                classes="px-4! py-3! border border-gray-300 rounded-lg focus:outline-none focus:border-green-800 transition-all"
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <SelectInputController
                  control={control}
                  name="categoryId"
                  classes="w-full px-3! oy-2! border border-gray-300 rounded-lg focus:outline-none focus:border-green-500 transition-all"
                  options={[
              ...
              <div className="flex flex-col">
                ...
                <Upload showUploadList={false}>
                    <Button
                    className="h-10!  w-100!  px-3! py-2!flex justify-between items-center border border-gray-300 rounded-lg bg-white text-gray-800 transition-all hover:bg-gray-100"
