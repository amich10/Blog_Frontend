...
const ListPosts: React.FC = () => {
  ...
  return (
    ...
    <div className="flex h-full">
      {/* Left Panel */}
      <div className="w-3/4 border-r border-gray-200 h-full px-6 overflow-y-auto"> {/* Added overflow-y-auto here */}
        {/* Category Scrollbar */}
        ...
        <div className="mt-2">
          ...
          <List
            ...
            renderItem={(item) => (
              <List.Item>
                <List.Item.Meta
                  title={<span className="text-[#4f6f52] font-serif font-semibold">{item.title}</span>}
                  description={item.excerpt}
                />
              </List.Item>
            )}
