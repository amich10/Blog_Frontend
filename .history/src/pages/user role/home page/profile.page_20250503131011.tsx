        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <div class="flex flex-wrap gap-2">
                    <span class="px-3 py-1 bg-indigo-100 text-indigo-800 text-sm rounded-full">Technology</span>
                    <span class="px-3 py-1 bg-purple-100 text-purple-800 text-sm rounded-full">Design</span>
