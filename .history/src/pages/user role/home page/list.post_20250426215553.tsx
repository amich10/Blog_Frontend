  ...
  return (
    <Content className="shadow-xl rounded-md bg-white">
      <div className="flex h-full relative">
        {/* Left Panel */}
        <div className="w-3/4 border-r border-gray-200 h-full px-6 bg-yellow-300">
          {/* Categories */}
          <div className="flex items-center gap-3 p-6 border-b border-gray-100 bg-red-500 sticky top-0">
            <Button
              icon={<LeftOutlined />}
