          ...
          <div className="flex flex-row w-full justify-center items-center gap-3 p-6 border-b border-gray-100">
            ...
            >
              {categories.map((category, index) => (
                <div
                  key={index}
                  className="flex-shrink-0 bg-gray-100 hover:bg-[#4f6f52] hover hover:text-white px-4 py-2 rounded-full font-medium cursor-pointer transition duration-300 whitespace-nowrap"
