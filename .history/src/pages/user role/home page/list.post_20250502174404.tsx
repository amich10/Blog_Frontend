  ...
  return (
    <Content className="shadow-xl rounded-md bg-white relative">
      <div className="flex h-full">
        ...
        <Button
              type="primary"
              className="!bg-[#4f6f52] hover:!bg-[#3d5842] w-full h-20! flex justify-center items-center mb-3! shadow-lg!"
            >
             <div className="flex flex-col gap-1">
             <NavLink to={'/blogs/create'} className="text-white! font-semibold text-lg"> <FormOutlined/> Write your own Blog</NavLink>
             <span className="italic font-stretch-expanded">"{randomIdea}"</span>
             </div>
        </Button>
