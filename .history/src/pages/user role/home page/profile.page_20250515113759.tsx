            ...
            <div className="flex justify-between  items-end -mt-16 mb-4 mx-2">
                <div className="flex items-end">
                    <div className="relative">
                        <img src={userDetails.imageoptimizedUrl} alt="profile" className="h-32 w-32 rounded-full border-4 border-white" />
                    ...
                    <div className="ml-6 mb-4">
                        <h1 className="text-xl font-bold text-[#4f6f52]">{userDetails.fullName}</h1>
                        <p className="text-[#4f6f52]">@{userDetails.username}</p>
                    </div>
                </div>
                <div className="flex mb-4">
                      <Button onClick={() => navigate('/blogs/profile-edit')} className="bg-[#4f6f52]! text-white! rounded-xl!"> <EditOutlined className="mr-1!"/>Edit Profile</Button>
                </div>
