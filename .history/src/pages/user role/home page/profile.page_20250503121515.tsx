            ...
            <div className="px-6 pb-6 relative">
                <div className="flex items-end">
                    <div className="relative">
                        ...
                        <button className="absolute bottom-2 right-2 bg-indigo-600 text-white p-2 rounded-full" title="Edit Profile Picture" aria-label="Edit Profile Picture"><CameraOutlined/></button>
                    </div>
                </div>
            </div>
        </div>
