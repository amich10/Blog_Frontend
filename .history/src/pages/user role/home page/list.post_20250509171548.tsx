          ...
          >
            ...
            <List className="border border-gray-100 px-3!"
              ...
              <List.Item>
                <List.Item.Meta
                title={
                  <span onClick={() => navigate(`/blogs/${item.slug}`)} className="text-[#4f6f52] font-semibold font-serif hover:cursor-default">
                  {item.title}
                  </span>
                }
                description={<span className="text-[14px]">{item.excerpt}</span>}
                />
              </List.Item>
              )}
            />
