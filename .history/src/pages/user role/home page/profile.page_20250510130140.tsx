import { CalendarOutlined, CameraOutlined, EditOutlined, EnvironmentOutlined, LikeOutlined, LinkOutlined, MessageFilled, MessageOutlined} from "@ant-design/icons";
                        ...
                        .map((category, idx) => (
                            <span
                                ...
                                className={`px-3 py-1 text-sm rounded-full ${
                                    ["bg-indigo-100 text-indigo-800", "bg-purple-100 text-purple-800", "bg-green-100 text-green-800"][idx % 3]
                                }`}
                            >
                                {category}
                            </span>
