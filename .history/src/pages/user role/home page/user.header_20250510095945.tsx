...
const UserHeader = () => {
  ...
  return (
    ...
    <Layout.Header className='bg-white! flex border-b border-gray-100 m-0 rounded-md '>
       ...
       <div className="flex justify-between font-serif text-2xl font-bold bg-gray-300! w-70"><NavLink to={'/blogs'} className="text-[#4f6f52]!">Writelle</NavLink>
       <span className="text-gray-500! text-xl">Hello, {userDetails.username}</span>
       </div>
        </div>
        <div className='flex'>
          <Dropdown
