    ...
    <Layout.Content className="container mx-auto px-6 py-8 bg-gray-500">
      <div className="max-w-4xl  mx-auto bg-white rouded-xl shadow-sm  overflow-hidden ">
        ...
        <form className="px-8 py-6 space-y-6">
          <div>
            <InputLabel htmlFor="title" classses={"block text-sm font-medium mb-2 text-gray0-700"}>Blog Title</InputLabel>
            <TextInputController type="text" control={control} name="title" placeholder="Enter your blog title" classes={'px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-green-800 focus:border-transparent transition-all '}/>
          </div>
        </form>
