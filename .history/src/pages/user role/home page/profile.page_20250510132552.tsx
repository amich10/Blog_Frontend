...
const ProfilePage = () =>{
   ...
   return(
    ...
    <main className="w-max-6xl mx-auto px-4 py-4 bg-white">
        ...
        {/* profile header */}
        <div className="bg-white rounded-lg border border-gra overflow-hidden mb-8">
            {/* cover page */}
        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                {posts.map((post) => (
                    <div key={post._id} className="bg-white shadow-md hover:shadow-lg overflow-hidden transition rounded-xl">
                        <img
