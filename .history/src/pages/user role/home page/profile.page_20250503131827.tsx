    ...
    <main className="w-max-6xl mx-auto px-4 py-4 bg-white">
        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                <div className="bg-white shodow-md hover:shadow-lg overflow-hidden transition">
                    <img src="https://source.unsplash.com/random/400x200/?technology" alt="Blog post" class="w-full h-48 object-cover"/>
                </div>
            </div>
