...
const ProfilePage = () =>{
  ...
  try {
    ...
    notifcation("Failed to update profile. Please try again.",NotificationType.ERROR)
  }
};
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
            ...
            <div className="flex justify-between  items-end -mt-16 mb-4 mx-2">
                ...
                <div className="flex mb-4">
                      <Button onClick={() => setEditModalVisible(true)} className="bg-[#4f6f52]! text-white! rounded-xl!"> <EditOutlined className="mr-1!"/>Edit Profile</Button>
                      <EditProfileModal
