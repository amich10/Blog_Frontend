    ...
    <Content className="shadow-xl rounded-md bg-white relative">
      <div className="flex h-full">
        ...
        <div className="w-3/4 border-r border-gray-200 h-full px-6">
              ...
              >
                <List.Item.Meta
                  ...
                  title={
                    <div className="flex flex-col">
                       <span className="text-xs text-gray-400">
                        {users.find((user) => user._id === item.authorId._id)?.fullName || "Unknown"}
                      </span>
                      <a
                  ...
                  description={ <div className="flex items-center justify-between">
                    <p className="text-gray-600 max-w-[80%]">{item.excerpt}</p>
                    <Button
                      type="link"
          ...
          <Button
            type="default"
            className="text-[#4f6f52] border-[#4f6f52] hover:!bg-[#4f6f52] hover:!text-white font-medium rounded-md"
            onClick={() => navigate(`/blogs/${item.slug}`)}
          >
            Load More
          </Button>
