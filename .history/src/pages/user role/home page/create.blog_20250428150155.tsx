        ...
        <div className="max-w-4xl  mx-auto bg-white rouded-xl shadow-sm  overflow-hidden ">
          ...
          <form className="px-8 py-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* cover image */}
              <div>
                <InputLabel htmlFor="image" className="block">Cover Image</InputLabel>
                <Upload>
                  <Button className="h-10 w-full flex justify-between items-center">
                    <span>Upload an Image</span> <FileImageOutlined />
                  </Button>
                </Upload>
              </div>
            </div>
