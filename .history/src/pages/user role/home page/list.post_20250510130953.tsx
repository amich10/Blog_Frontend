    ...
    <Content className="shadow-xl rounded-md bg-white relative">
      <div className="flex h-full">
            ...
            renderItem={(item) => (
              <List.Item
                ...
                actions={[
                  ...
                  <Button
                    type="link"
                    className="text-blue-600! hover:bg-green-900"
                    icon={
                      <IconText
                ...
                <List.Item.Meta
                  ...
                  title={
                    <div className="flex flex-col">
                      ...
                      >
                        <span className="text-blue-600 font-serif font-semibold">
                          {" "}
                          {item.title}
                        </span>
                      </a>
                  ...
                  description={
                    <div>
                      ...
                      <Button
                        type="link"
                        className="text-blue-600! font-semibold! font-serif! text-xs! underline!"
                        onClick={() => navigate(`/blogs/${item.slug}`)}
                      >
                        Load More
                      </Button>
        ...
        <div className="w-1/4 h-full p-4 space-y-8 sticky top-0">
          <Button
            type="primary"
            className="!bg-blue-600 hover:!bg-[#3d5842] w-full h-20! flex justify-center items-center mb-3! shadow-lg! border-b-2! border-gray-300!"
          ...
          <Card
            className="mt-2"
            title={
              <span className="text-blue-600 font-semibold font-serif text-xl">
                Featured Posts
              </span>
            }
          >
                ...
                <List.Item>
                  <List.Item.Meta
                    title={
                      <span
                        onClick={() => navigate(`/blogs/${item.slug}`)}
                        className="text-blue-600 font-semibold font-serif hover:cursor-pointer"
                      >
                        {item.title}
                      </span>
                    }
