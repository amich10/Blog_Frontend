    ...
    <Content className="shadow-xl rounded-md bg-white">
      <div className="flex h-full">
        ...
        <div className="w-1/4 h-full p-6">
          ...
          <div className="mb-6">
            <Card title="Featured Posts" className="h-full">
              <List
          ...
          {/* Write Blog Box Section */}
            ...
            <Card title="Recommended Topics" className="mb-6">
            <List
              dataSource={["React", "TypeScript", "UI/UX", "Node.js", "Cloud"]}
              renderItem={(topic) => (
              <List.Item>
                <Button type="link">{topic}</Button>
              </List.Item>
              )}
            />
            </Card>
