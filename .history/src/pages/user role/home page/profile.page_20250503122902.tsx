    ...
    <main className="w-max-6xl mx-auto px-4 py-4 bg-white">
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden mb-8 border">
            ...
            <div className="flex justify-between -mt-16 mb-4">
                <div className="flex items-end bg-amber-200">
                ...
                <div className="flex space-x-3 mb-4">
                        <button title="follow" className=" h-10 w-10 px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition">Follow</button>
