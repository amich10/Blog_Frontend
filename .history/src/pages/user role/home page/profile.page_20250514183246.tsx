    ...
    <main className="w-max-6xl mx-auto px-4 py-4 bg-white">
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
            ...
            <div className="flex justify-between  items-end -mt-16 mb-4 mx-2">
                <div className="flex items-end">
                    <div className="relative">
                        ...
                        <button type="button"  title="edit profile pic" className="absolute bottom-2 right-2 bg-[#4f6f52] text-white p-2 rounded-full"><EditOutlined/></button>
                    </div>
                ...
                <div className="flex mb-4">
                      <Button onClick={toggleModal} className="bg-[#4f6f52]! text-white! rounded-xl!">
                      ...
                      {isOpen && (
                        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
                          <div className="bg-white rounded-lg p-6 w-full max-w-md relative">
                            ...
                            <h2 className="text-lg font-bold mb-4 text-[#4f6f52]">Edit Profile</h2>
                            {/* Simple form example, replace with your actual form */}
                            <form>
                              <div className="mb-4">
                                <label className="block text-sm mb-1 text-[#4f6f52]">Name</label>
                                <input
                                  type="text"
                              ...
                              <div className="mb-4">
                                <label className="block text-sm mb-1 text-[#4f6f52]">Bio</label>
                                <textarea
                              ...
                              <div className="flex justify-end">
                                <Button type="primary" htmlType="submit" className="bg-[#4f6f52]! text-white! rounded-xl!">
                                  Save
                                </Button>
                              </div>
                            </form>
            ...
            <div className="flex flex-wrap mx-2 text-sm mb-1">
                ...
                <div className="flex items-center gap-x-1 mr-6">
                    <LinkOutlined/>
                    <a href={userDetails?.socialMedia}>{userDetails?.socialMedia}</a>
                </div>
                <div className="flex items-center gap-x-1 mr-6">
                    <CalendarOutlined/>
        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                {posts.map((post) => (
                    <div key={post._id} className="bg-white shadow-md hover:shadow-lg hover:cursor-pointer overflow-hidden transition rounded-xl" onClick={() => navigate('/blogs/' + post.slug)}>
                        <img
