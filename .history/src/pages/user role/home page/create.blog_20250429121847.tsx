          ...
          <form className="px-8 py-6 space-y-6" onSubmit={handleSubmit((data) => console.log(data))}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <Upload>
                  <Button className="h-10! w-100 flex! justify-between! focus:outline-none! focus:ring-2! focus:ring-green-600! focus:border-transparent! transition-all!">
            ...
            <div>
              ...
              <TextAreaController autoSize={{minRows:20}} control={control} name="content" placeholder="write your blog content here..." errorMsg={errors?.content?.}/>
            </div>
            <div className="flex justify-end">
              <Button htmlType="submit" disabled={isSubmitting} loading={isSubmitting || loading}>
