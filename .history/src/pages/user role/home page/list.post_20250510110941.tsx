        ...
        <div className="w-1/4 h-full p-4 space-y-8 sticky top-0">
          ...
          >
            <List
              ...
              dataSource={
                posts
                  .filter((post) => post._id !== loggedInuserId)
              ...
              renderItem={(post) => (
                <List.Item
                  actions={[
                    <Button
                      ...
                      key="follow"
                      onClick={()=> handleFollowClick(post.authorId._id)}
                    >
                ...
                >
                  <List.Item.Meta
                    avatar={<Avatar src={post.authorId._id?.image?.optimizedUrl} />}
                    title={
                      <span className="text-[#4f6f52]">{post.authorId._id?.username}</span>
                    }
                  />
                </List.Item>
              )}
