      ...
      <div className="max-w-4xl  mx-auto bg-white rouded-xl shadow-sm  overflow-hidden ">
        ...
        <form className="px-8 py-6 space-y-6">
          <div>
            ...
            <TextInputController type="text" control={control} name="title" placeholder="Enter your blog title" classes={'px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-green-800 focus:border-transparent '}/>
          </div>
        </form>
