        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
            ...
            <div className="flex justify-between  items-end -mt-16 mb-4 mx-2">
                ...
                <div className="flex mb-4">
                      <Button onClick={toggleModal} className="bg-[#4f6f52]! text-white! rounded-xl!"> <EditOutlined className="mr-1!"/>Edit Profile</Button>
                      {isOpen && (
  <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50">
    <div className="bg-white rounded-2xl p-6 w-full max-w-lg shadow-lg relative">
      <h2 className="text-xl font-bold text-[#4f6f52] mb-4">Edit Profile</h2>
      <form className="space-y-4">
        ...
        <div>
          ...
          <input
            type="text"
            defaultValue={userDetails.socialMedia}
            className="w-full border rounded-md p-2"
          />
        </div>
        <div className="flex justify-end gap-2 mt-4">
          ...
          <button
            type="submit"
            className="px-4 py-2 bg-[#4f6f52] text-white rounded-md"
          >
            Save
          </button>
        </div>
