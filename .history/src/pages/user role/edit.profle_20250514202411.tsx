...
import { InputLabel, TextAreaController, TextInputController } from "../../components/input.component";
          ...
          <div className="relative h-48 bg-gray-200">
            ...
            <div className="absolute bottom-4 right-4">
              <Upload {...coverImageUploadProps} showUploadList={false}>
                <Button className=" px-4 py-2 rounded-md hover:bg-opacity-100 transition">
                  <EditOutlined/>
                </Button>
              </Upload>
            </div>
          ...
          <div className="px-6 py-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                 ...
                 <div>
                  <InputLabel htmlFor="username" classses={"block text-sm font-medium text-gray-700 mb-1"}>Username</InputLabel>
                  <TextInputController
                    type="text"
                    name="username"
                    control={control}
                ...
                <div className="md:col-span-2">
                 <InputLabel htmlFor="bio" classses={"block text-sm font-medium text-gray-700 mb-1"}>Bio</InputLabel>
                  <TextAreaController
                    name="bio"
                    control={control}
                 ...
                 <div className="md:col-span-2">
                 <InputLabel htmlFor="addresss" classses={"block text-sm font-medium text-gray-700 mb-1"}>Bio</InputLabel>
                  <TextInputController
                    name="address"
                    control={control}
                 ...
                 <div className="md:col-span-2">
                 <InputLabel htmlFor="SocailMedia" classses={"block text-sm font-medium text-gray-700 mb-1"}>Social Media </InputLabel>
                  <TextInputController
                    name="socialMedia"
                    control={control}
