      ...
      <Layout.Content className="p-4 bg-white min-h-screen">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            ...
            <Statistic
              ...
              prefix={<EditOutlined className="text-blue-500 text-xl" />}
            />
            </Card>
            <Card className="shadow-md rounded-lg border border-gray-100">
            <Statistic
              ...
              prefix={<TagsOutlined className="text-green-500 text-xl" />}
            />
            </Card>
            <Card className="shadow-md rounded-lg border border-gray-100">
            <Statistic
              ...
              value={users.length}
              valueStyle={{ color: "#f59e42", fontWeight: 600, fontSize: 28 }}
              prefix={<UserOutlined className="text-orange-500 text-xl" />}
            />
            </Card>
        </div>
