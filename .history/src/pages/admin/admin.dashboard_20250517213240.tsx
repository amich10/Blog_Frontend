      ...
      {loading ? (
        ...
        <Layout.Content className="p-4 bg-white min-h-screen">
          <div className="border-b pb-4 mb-6">
            <Title level={2} className="!mb-0 !text-2xl font-semibold text-gray-800">
              Dashboard
            </Title>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <Card className="shadow-md rounded-lg border-0 hover:shadow-lg transition-shadow duration-200" bodyStyle={{ padding: "24px 20px" }}>
              <Statistic
