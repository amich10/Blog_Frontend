import { ArrowUpOutlined, CommentOutlined, EditOutlined, EyeOutlined, FileImageOutlined, MoreOutlined, PlusOutlined, TagsOutlined, UserOutlined } from "@ant-design/icons";
            ...
            <Col xs={24} lg={8}>
              <Card title="Quick Actions" style={{ marginBottom: '16px' }}>
                <Row gutter={[16, 16]}>
                  ...
                  <Col span={12}>
                    <Button type="dashed" block icon={<UserA />} style={{ height: '80px' }}>
                      Add User
                    </Button>
                  </Col>
                </Row>
