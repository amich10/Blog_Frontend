...
const ListPosts: React.FC = () => {
  ...
  const retrievePosts = async ({
    ...
    search = "",
    categoryId = null,
  }: IQueryType & { categoryId: string | null }) => {
    try {
      setLoading(true);
                    ...
                    title={
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs text-gray-400">
                          {Math.max(
                            1,
                            Math.round((item.content.length || 500) / 200)
                          )}{" "}
                          min read
                        </span>
                      </div>
        ...
        <div className="w-1/4 h-full p-4 space-y-8 sticky top-0">
          ...
          >
            <Spin
              ...
              className="w-full text-gray-400! font-semibold!"
            >
            <List
                  ...
                  <List.Item.Meta
                    avatar={
                      <Avatar
                        ...
                        onClick={() => navigate(`/blogs/profile/${user._id}`)}
                      />
                    }
                    title={
                      <span
